  ...
  return new Container(
    ...
    child: new Wrap(
      ...
      children: List.generate(state.items.length, (index){
        return items(state.items[index],index,dispatch);
      }),
    ),
  );
}
Widget items(Map<String,dynamic>itemdata,int index,Dispatch dispatch){
  return new GestureDetector(
    onTap: (){
      dispatch(CliteleItemCellActionCreator.onAction(index));
    },
    child: Container(
      width: Adapt.px(150),
      child: new Column(
